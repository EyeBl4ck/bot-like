        ...
        if rt == "PAGO":
           ## rt = "PAGO"
            ...
            await c.send_message(
                ADMIN_CHAT,
                f"<a href='https://t.me/Lonsepo'>&#8204</a>💰 {mention} Adicionou <b>R${value}</b> de saldo\n\n<a href='https://t.me/Lonsepo'>SUPORTE</a>",
            )
            mention = user.first_name
            await c.send_message(
                GRUPO_PUB,
                f"<a href=''>&#8204</a>💰 PAGAMENTO REALIZADO COM SUCESSO!\n<b>User:{mention}\n</b>🔗 SALDO: R$ {value}\n\n<a href='https://t.me/LojinhaBetano_Bot'>Adicionar saldo na store</a>",
            )
...
async def auto_pay(c: Client, m: Union[CallbackQuery, Message]):
    ...
    if isinstance(m, CallbackQuery):
        ...
        cob = await m.message.ask(
            f"""<b>💎 Digite o valor (Apenas Números) que você quer depositar (mínimo R$ {min_value}). Exemplo:
...
⚠️ Se não conseguir realizar Pix, chame o: @neokingbet
"""
