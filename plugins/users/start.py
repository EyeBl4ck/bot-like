...
async def start(c: Client, m: Union[Message, CallbackQuery]):
            ...
            if refer is not None:
                ...
                try:
                    await c.send_message(
                        refer,
                        text=f"<b>🎁 Parabéns, o usuário {mention} se vinculou com seu link de afiliado e você receberá uma porcentagem (10%) do que consumir em nosso bot</b>",
                    )
                except BadRequest:
                    pass
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
InlineKeyboardButton("☃️ Minhas Compras e Afiliados", callback_data="user_info"),
...
🛒 - @LojinhaBetanoBot
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
✅ Contas Betano, Emails e Dados CPF Livre Verificados!
⚠️ Para começar do zero digita /start
💰 Faça recargas pelo /pix
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
🟢 Bot Online

Dúvidas, angústias e aflições: @neokingbet"""
